...
{
    public abstract class CardMonoSharedFabric<TSharedConfig, TCardController, TConcreteShared> : CardMonoSharedComponent
    ...
    public abstract class ComponentConfig<TConfig> : ComponentConfig
